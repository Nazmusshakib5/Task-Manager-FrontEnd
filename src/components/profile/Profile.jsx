...
import {GetProfileDetails, ProfileUpdateRequest} from "../../APIRequests/APIRequest.js";
import {useSelector} from "react-redux";
import {ErrorToast, getBase64, IsEmail, IsEmpty, IsMobile} from "../../helper/FormValidationHelper.js";
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-md-3  p-2">
                                        <button onClick={UpdateMyProfile}  className="btn w-100 float-end btn-primary mainBtn animated fadeInUp">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
